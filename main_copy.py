...
class AerialImageDataSet(Dataset):
    def __init__(self, path, samples = 350, preprocessing=None):
...
def main():
    ...
    #ALTERNATE MODEL: FPN model with EfficientnetB3 encoder
    #Takes too long to run, haven't tested yet
    ...
    for i in range(NUM_EPOCHS):
        ...
        #Reduce LR on 5th epoch, feel free to change this
        if i == 5:
